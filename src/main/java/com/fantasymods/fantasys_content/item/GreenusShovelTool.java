...
public class GreenusShovelTool {
	public static final ToolMaterial GREENUSSHOVEL_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new ShovelItem(GREENUSSHOVEL_TOOL_MATERIAL, 0, (float) -3,
