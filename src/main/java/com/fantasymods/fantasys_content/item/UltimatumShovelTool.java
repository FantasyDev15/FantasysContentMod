...
public class UltimatumShovelTool {
	public static final ToolMaterial ULTIMATUMSHOVEL_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new ShovelItem(ULTIMATUMSHOVEL_TOOL_MATERIAL, 0, (float) -3,
