...
public class BloonusPickaxeTool {
	public static final ToolMaterial BLOONUSPICKAXE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new PickaxeItem(BLOONUSPICKAXE_TOOL_MATERIAL, 0, (float) -3,
