...
public class ExperteniumHoeTool {
	public static final ToolMaterial EXPERTENIUMHOE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new HoeItem(EXPERTENIUMHOE_TOOL_MATERIAL, 0, (float) -3,
