...
public class MaestrariumPickaxeTool {
	public static final ToolMaterial MAESTRARIUMPICKAXE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new PickaxeItem(MAESTRARIUMPICKAXE_TOOL_MATERIAL, 0, (float) -3,
