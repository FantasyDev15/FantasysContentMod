...
public class ExtremumShovelTool {
	public static final ToolMaterial EXTREMUMSHOVEL_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new ShovelItem(EXTREMUMSHOVEL_TOOL_MATERIAL, 0, (float) -3,
