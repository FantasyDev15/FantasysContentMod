...
public class UltimatumAxeTool {
	public static final ToolMaterial ULTIMATUMAXE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new AxeItem(ULTIMATUMAXE_TOOL_MATERIAL, 0, (float) -3,
