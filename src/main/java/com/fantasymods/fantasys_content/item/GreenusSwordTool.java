...
public class GreenusSwordTool {
	public static final ToolMaterial GREENUSSWORD_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new SwordItem(GREENUSSWORD_TOOL_MATERIAL, 0, (float) -3,
