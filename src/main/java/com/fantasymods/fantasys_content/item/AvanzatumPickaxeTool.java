...
public class AvanzatumPickaxeTool {
	public static final ToolMaterial AVANZATUMPICKAXE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new PickaxeItem(AVANZATUMPICKAXE_TOOL_MATERIAL, 0, (float) -3,
