...
public class AvanzatumHoeTool {
	public static final ToolMaterial AVANZATUMHOE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new HoeItem(AVANZATUMHOE_TOOL_MATERIAL, 0, (float) -3,
