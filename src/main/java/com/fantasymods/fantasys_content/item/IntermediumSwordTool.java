...
public class IntermediumSwordTool {
	public static final ToolMaterial INTERMEDIUMSWORD_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new SwordItem(INTERMEDIUMSWORD_TOOL_MATERIAL, 0, (float) -3,
