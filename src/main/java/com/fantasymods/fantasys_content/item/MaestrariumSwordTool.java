...
public class MaestrariumSwordTool {
	public static final ToolMaterial MAESTRARIUMSWORD_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new SwordItem(MAESTRARIUMSWORD_TOOL_MATERIAL, 0, (float) -3,
