...
public class BloonusHoeTool {
	public static final ToolMaterial BLOONUSHOE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new HoeItem(BLOONUSHOE_TOOL_MATERIAL, 0, (float) -3,
