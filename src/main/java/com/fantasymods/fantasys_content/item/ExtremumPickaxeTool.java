...
public class ExtremumPickaxeTool {
	public static final ToolMaterial EXTREMUMPICKAXE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new PickaxeItem(EXTREMUMPICKAXE_TOOL_MATERIAL, 0, (float) -3,
