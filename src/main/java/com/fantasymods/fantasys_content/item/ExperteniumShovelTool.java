...
public class ExperteniumShovelTool {
	public static final ToolMaterial EXPERTENIUMSHOVEL_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new ShovelItem(EXPERTENIUMSHOVEL_TOOL_MATERIAL, 0, (float) -3,
