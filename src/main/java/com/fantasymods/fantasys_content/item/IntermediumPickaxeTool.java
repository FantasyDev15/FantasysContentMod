...
public class IntermediumPickaxeTool {
	public static final ToolMaterial INTERMEDIUMPICKAXE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new PickaxeItem(INTERMEDIUMPICKAXE_TOOL_MATERIAL, 0, (float) -3,
