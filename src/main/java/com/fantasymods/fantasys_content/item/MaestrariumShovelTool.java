...
public class MaestrariumShovelTool {
	public static final ToolMaterial MAESTRARIUMSHOVEL_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new ShovelItem(MAESTRARIUMSHOVEL_TOOL_MATERIAL, 0, (float) -3,
