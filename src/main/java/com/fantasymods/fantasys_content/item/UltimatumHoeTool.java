...
public class UltimatumHoeTool {
	public static final ToolMaterial ULTIMATUMHOE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new HoeItem(ULTIMATUMHOE_TOOL_MATERIAL, 0, (float) -3,
