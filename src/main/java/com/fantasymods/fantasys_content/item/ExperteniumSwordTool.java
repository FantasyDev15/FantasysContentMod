...
public class ExperteniumSwordTool {
	public static final ToolMaterial EXPERTENIUMSWORD_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new SwordItem(EXPERTENIUMSWORD_TOOL_MATERIAL, 0, (float) -3,
