...
public class GreenusAxeTool {
	public static final ToolMaterial GREENUSAXE_TOOL_MATERIAL = new ToolMaterial() {
		@Override
	...
	public static final Item INSTANCE = new AxeItem(GREENUSAXE_TOOL_MATERIAL, 0, (float) -3,
