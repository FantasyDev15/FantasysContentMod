...
public class MaestrariumOreBlock extends Block {
	...
	public static class Generation {
		private static final RuleTestType<CustomRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new Identifier("fantasys_mod", "maestrarium_ore_match"), () -> CustomRuleTest.codec);
		public static final Feature<OreFeatureConfig> feature = Registry.register(Registry.FEATURE, new Identifier("fantasys_mod", "maestrarium_ore"),
		...
		private static final ConfiguredFeature<?, ?> CONFIG_FEATURE = feature
				.configure(new OreFeatureConfig(CustomRuleTest.INSTANCE, FantasysModMod.MaestrariumOre_BLOCK.getDefaultState(), 1)).rangeOf(9)
		...
		public static void init() {
			RegistryKey<ConfiguredFeature<?, ?>> configFeatKey = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
					new Identifier("fantasys_mod", "maestrarium_ore"));
