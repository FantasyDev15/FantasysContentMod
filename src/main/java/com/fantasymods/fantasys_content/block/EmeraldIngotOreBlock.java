...
public class EmeraldIngotOreBlock extends Block {
	...
	public static class Generation {
		private static final RuleTestType<CustomRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new Identifier("fantasys_mod", "emerald_ingot_ore_match"), () -> CustomRuleTest.codec);
		public static final Feature<OreFeatureConfig> feature = Registry.register(Registry.FEATURE,
				new Identifier("fantasys_mod", "emerald_ingot_ore"), new OreFeature(OreFeatureConfig.CODEC) {
					@Override
		...
		private static final ConfiguredFeature<?, ?> CONFIG_FEATURE = feature
				.configure(new OreFeatureConfig(CustomRuleTest.INSTANCE, FantasysModMod.EmeraldIngotOre_BLOCK.getDefaultState(), 5)).rangeOf(46)
		...
		public static void init() {
			RegistryKey<ConfiguredFeature<?, ?>> configFeatKey = RegistryKey.of(Registry.CONFIGURED_FEATURE_WORLDGEN,
					new Identifier("fantasys_mod", "emerald_ingot_ore"));
